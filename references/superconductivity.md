...
- A simple Allen-Dynes estimate is useful for screening, not a substitute for a full superconductivity study.
- `lambda` and `omega_log` should be discussed together.
