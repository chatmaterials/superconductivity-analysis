...
Standalone skill for superconductivity-relevant DFT result analysis, including candidate ranking by Tc and phonon stability.
...
python3 scripts/compare_superconducting_candidates.py fixtures fixtures/candidates/unstable-strong --mu-star 0.10 --target-tc 0.5 --json
